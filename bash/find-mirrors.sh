...
# Available: https://gist.githubusercontent.com/alexdelorenzo/8cdb21718c2d2d3f5f8beaad0bf6c843/raw/f8f9bf73bd4a55cdde25febe7a0be276011ae33c/find-mirrors.sh
#
export ARCH="${1:-amd64}"
